...
\subsubsection{4. Create web app distribution build and copy it to the virtual machine.}

\subsubsection{5. Configure distribution build and create Upstart script.}
